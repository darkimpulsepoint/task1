...
class NumericArrayServiceTest {
    ...
    private IntegerArraySortService sortService;
    private IntegerArrayMathService mathService;

    @BeforeEach
    void setUp() {
        sortService = new IntegerArraySortService();
        mathService = new IntegerArrayMathService();
    }
